...
write.csv(final,file="C:/Users/Jungwoo Lim/Documents/2018년 과제/PSAT/통원팀/Data/final_data4.csv",row.names = TRUE)
write.csv(semi_final,file="C:/Users/Jungwoo Lim/Documents/2018년 과제/PSAT/통원팀/Data/final_data4.1.csv",row.names = TRUE)
...
a<-read.csv("final_data.csv",header=T)
sum(is.na(a$rainfall))
data<-read.csv("final_data5.csv",header = T)
str(data)
...
airline_count$Freq<-as.character(airline_count$Freq)
data_final_count<-left_join(data_final,airline_count,by=c("Airline"="Var1"))
data_final_count$Freq<-as.integer(data_final_count$Freq)
...
str(data_final_count)
data_final_count_dep<-left_join(data_final_count,airports_need3,by=c("airport_arrival"="airports.iata_code"))
write.csv(data_final_count_dep,file="C:/Users/Jungwoo Lim/Documents/2018년 과제/PSAT/통원팀/Data/final_data6.csv")

names(data_final_count_dep)

data_final_final<-read.csv("final_data6.csv",header=T)
...
str(data_final_final)  
write.csv(data_final_final2,file="C:/Users/Jungwoo Lim/Documents/2018년 과제/PSAT/통원팀/Data/final_data7.csv")
...
levels(airports_final4$continent)
airports_final5
...
write.csv(data_final4,file="C:/Users/Jungwoo Lim/Documents/2018년 과제/PSAT/통원팀/Data/final_data8.csv")

mean_final<-read.csv("final_data8.csv",header=T)
...
write.csv(real_final,file="C:/Users/Jungwoo Lim/Documents/2018년 과제/PSAT/통원팀/Data/final_data9.csv")
levels(real_final$iso_country)
sum(is.na(real_final$iso_country))
